...
import { Briefcase, User, Lock, Eye, EyeOff, Info } from 'lucide-react';
...
const EmployeeLogin = () => {
  ...
  const validateForm = () => {
    ...
    if (!email) {
      newErrors.email = 'Email nhân viên là bắt buộc';
    ...
    if (validateForm()) {
      ...
      try {
        ...
        if (response.data.success) {
          login(response.data.data, response.data.token, 'employee');
    ...
    <div className="employee-login-container">
      ...
      <div className="employee-login-card">
        <div className="employee-card-header">
          ...
          <h1 className="employee-card-title">Cổng Nhân Viên</h1>
          <p className="employee-card-description">
            Đăng nhập để xem lịch làm việc và nhiệm vụ
          </p>
        </div>
        ...
        <div className="employee-card-content">
          <div className="employee-alert">
            ...
            <p className="alert-text">
              Sử dụng email nhân viên và mật khẩu được cấp bởi quản lý
            </p>
          </div>
