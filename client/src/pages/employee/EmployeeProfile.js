  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (token) {
          login({ ...user, ...formData }, token, 'employee');
        }
        ...
        <div className="col-lg-8">
          <div className="profile-card">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="row mb-3">
                <label className="col-sm-3 col-form-label">Khu vực phụ trách</label>
                <div className="col-sm-9">
                  <p className="form-control-plaintext">
                    {profile?.responsibleArea || 'Chưa được phân công'}
                  </p>
                  <small className="text-muted">
                    Liên hệ quản lý để thay đổi khu vực phụ trách
                  </small>
                </div>
              </div>
        ...
        <div className="col-lg-4">
          <div className="profile-stats-card">
            <div className="profile-avatar">
              <div className="avatar-circle employee-avatar">
            ...
            <div className="stats-list">
              ...
              <div className="stat-item">
                ...
                <div>
                  <p className="stat-label">Quản lý phụ trách</p>
                  <p className="stat-value">{profile?.managerName || 'Chưa gán'}</p>
                </div>
              </div>
          ...
          <div className="help-card mt-4">
            <h4>Cần hỗ trợ?</h4>
            <p>Liên hệ với quản lý hoặc admin nếu bạn gặp bất kỳ vấn đề nào.</p>
